...
> Scrape Twitch channels, streams, chat without API

[![Python 3.11+](https://img.shields.io/badge/Python-3.11+-blue?style=flat-square&logo=python)](https://www.python.org/)
[![License: MIT](https://img.shields.io/badge/License-MIT-green?style=flat-square)](LICENSE)
[![Stars](https://img.shields.io/github/stars/data-scrape/twitch-scraper?style=flat-square)](https://github.com/data-scrape/twitch-scraper)
[![Forks](https://img.shields.io/github/forks/data-scrape/twitch-scraper?style=flat-square)](https://github.com/data-scrape/twitch-scraper/forks)
...
**Twitch Scraper** is a free, open-source Python scraper for **Twitch**. Extract structured data from twitch with full pagination support, proxy rotation, and multiple export formats.

twitch scraper, scrape twitch, twitch data scraper

## ✨ Features

- ✅ Channel info & stats
- ✅ Stream metadata extraction
- ✅ Chat message scraping
- ✅ Follower & viewer counts
...
```bash
git clone https://github.com/data-scrape/twitch-scraper.git
cd twitch-scraper
...
```bash
python scraper.py "Top Just Chatting streamers live now"
```
...
`channel_name` | `display_name` | `followers` | `view_count` | `is_live` | `stream_title` | `game_name` | `viewer_count` | `started_at` | `tags` | `profile_image_url`

## 💡 Use Cases

- Streamer performance analytics
- Twitch market research
